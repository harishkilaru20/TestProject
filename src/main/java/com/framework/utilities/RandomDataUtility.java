...
public class RandomDataUtility {
    ...
    */
     ...
     * @return
     */
    public static String generateEmail(String extension)
    {
   	 String email=null;
   	 char[] name = generateRandomData(3, 20, 1, 1, 0);
   	 char[] data = generateRandomData(3, 20, 1, 1, 0);
   	
   	 email=new String(name)+"@"+new String(data)+pickDomain();
    ...
    /**
     * Generate Random MobileNumber with area Code
     * @return
     */
      public static String generateMobileNumber(int areaCode)
      {
     	 String mobileNumber=null;
     	 char[] number = generateRandomData(9, 9, 0, 9, 0);
     	
     	mobileNumber= areaCode+new String(number);
      ...
      /**
       * Generate Random DOmain from Array List 
       * @return
       */
 	 public static String pickDomain()
    {
       ...
       * List of Domains
       */
 	  public static void fillDefaultResponses()
 	    {
